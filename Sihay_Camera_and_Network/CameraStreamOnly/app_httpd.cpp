...
// --- FIX: FORCE DISABLE FACE DETECTION ---
// The libraries required for face detection are missing in ESP32 Core v3.x.
// We force these to 0 to prevent compilation errors.
